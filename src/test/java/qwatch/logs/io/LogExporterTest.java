...
public class LogExporterTest {
  ...
  public void exportJson_ok() {
    ...
    var entriesD1 = TreeSet.of(LogEntry.BY_DATE, d1e1, d1e2);
    var entriesD2 = TreeSet.of(LogEntry.BY_DATE, d2e1, d2e2);
  ...
  public void exportJson_pathAlreadyExists() throws Exception {
    ...
    var p = tempFolder.newFile("log.2019-01-01.json").toPath();
    ...
    var tryExport = exporter.export(entriesByDay);

    // Then the json file has been deleted and recreated again
    assertThat(tryExport.isSuccess()).isTrue();
